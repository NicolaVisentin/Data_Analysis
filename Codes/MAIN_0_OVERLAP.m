...
plot_powcross=0;    % power and cross spectra
...
overlap=0;  % assign overlap of the subrecords
...
ylabel('G_x_x [A^2]')
grid on
title('Power spectrum of the input (T=10, ovrl=0)')
axis tight
...
grid on
title('Power spectrum of the output (T=10, ovrl=0)')
axis tight
...
ylabel('|G_x_y|')
grid on
title('Cross spectrum (T=10, ovrl=0)')
axis tight
...
ylabel('G_x_x [A^2]')
grid on
title('PSD of the input (T=10, ovrl=0)')
axis tight
...
ylabel('G_y_y [(m/s^2)^2]')
grid on
title('PSD of the output (T=10, ovrl=0)')
axis tight
...
ylabel('|G_x_y|')
grid on
title('Cross spectrum density (T=10, ovrl=0)')
axis tight
...
xlabel('f [Hz]')
ylabel('\gamma^2_x_y')
title('Coherence function (T=10, ovrl=0)')
axis tight
...
grid on
title('H_1 estimator (T=10, ovrl=0)')
xlabel('f [Hz]')
ylabel('|H_1|')
axis tight
...
grid on
title('H_2 estimator (T=10, ovrl=0)')
xlabel('f [Hz]')
ylabel('|H_2|')
axis tight
...
semilogy(f_T_pos,abs(H2_pos))
grid on
title('Comparison between H_1 and H_2 (T=10, ovrl=0)')
xlabel('f [Hz]')
ylabel('amplitude')
legend('H_1','H_2')
axis tight
...
ylabel('G_x_x [A^2]')
grid on
title('Power spectrum of the input (T=50, ovrl=0)')
axis tight
...
ylabel('G_y_y [(m/s^2)^2]')
grid on
title('Power spectrum of the output (T=50, ovrl=0)')
axis tight
...
ylabel('|G_x_y|')
grid on
title('Cross spectrum (T=50, ovrl=0)')
axis tight
...
ylabel('G_x_x [A^2]')
grid on
title('PSD of the input (T=50, ovrl=0)')
axis tight
...
ylabel('G_y_y [(m/s^2)^2]')
grid on
title('PSD of the output (T=50, ovrl=0)')
axis tight
...
ylabel('|G_x_y|')
grid on
title('Cross spectrum density (T=50, ovrl=0)')
axis tight
...
xlabel('f [Hz]')
ylabel('\gamma^2_x_y')
title('Coherence function (T=50, ovrl=0)')
axis tight
...
semilogy(f_T_pos,abs(H1_pos))
grid on
title('H_1 estimator (T=50, ovrl=0)')
xlabel('f [Hz]')
ylabel('|H_1|')
axis tight
...
semilogy(f_T_pos,abs(H2_pos))
grid on
title('H_2 estimator (T=50, ovrl=0)')
xlabel('f [Hz]')
ylabel('|H_2|')
axis tight
...
semilogy(f_T_pos,abs(H2_pos))
grid on
title('Comparison between H_1 and H_2 (T=50, ovrl=0)')
xlabel('f [Hz]')
ylabel('amplitude')
legend('H_1','H_2')
axis tight
